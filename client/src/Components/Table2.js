...
import { MdDelete } from 'react-icons/md'; // Fixed import for MdDelete
                    ...
                    <td className={`${Text}`}>
                        <div className='w-12 p-1 bg-dry border border-border h-12 rounded overflow-hidden'>
                            <img
                                ...
                                src={`${data?.image ? data.image : "https://res.cloudinary.com/dwfmpiozq/image/upload/v1730028243/png-clipart-user-computer-icons-avatar-miscellaneous-heroes_re29tb.png"}`}
                                alt={data?.fullName}
                            />
                        </div>
                    </td>
